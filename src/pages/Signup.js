  ...
  render() {
    return (
      <div className="signup">
        ...
        <input type="checkbox" className="cheak"></input>
        <div className="agree">
          I agree to Ckare’s{" "}
          <span className="red">Terms & Conditions, Privacy Policy</span>
        </div>
        ...
        <div className="ahaccount">
          Already have an account? <span className="lin">Log in</span>
        </div>
      </div>
    );
  }
